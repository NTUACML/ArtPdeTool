function DemoIGA_NonLinearElasticity2D
clc; clear; close all;
%% Include package
...
operation1.setOperator('2D_nonlinear_elasticity');

%% Expression acquired
import MaterialBank.*
import BasicUtility.ElasticMaterialType.*

material = SaintVenantKirchhoff({0.3 1e5 ElasticMaterialType.PlaneStress});
...
iga_domain.generateConstraint(bdr_patch, u, {1, @()2});
...
% plot deformed nurbs
nurbs_topology.domain_patch_data_.nurbs_data_.control_points_(:,1:2) = ...
    nurbs_topology.domain_patch_data_.nurbs_data_.control_points_(:,1:2) + u.getVarData();
