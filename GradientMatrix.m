...
node_number = size(d_shape_func, 2);

for I = 1:node_number
    COL = (I-1)*3+1:(I-1)*3+3;
    BG(:,COL)=[d_shape_func(1,I)   0                   0;
               d_shape_func(2,I)   0                   0;
               d_shape_func(3,I)   0                   0;
               0                   d_shape_func(1,I)   0;
               0                   d_shape_func(2,I)   0;
               0                   d_shape_func(3,I)   0;
               0                   0                   d_shape_func(1,I);
               0                   0                   d_shape_func(2,I);
               0                   0                   d_shape_func(3,I)];
end
