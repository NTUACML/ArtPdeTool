function geometry = FEM_UnitCube_1_1_1(var)
...
%   Detailed explanation goes here
    ...
    %>> define element
    patch.element_data_{1} = BoundaryElement(patch.dim_, [1 2 3 4], neighbor_element_id, neighbor_element_data);
    patch.element_data_{1}.generateOrientation();
    ...
    %>> define element
    patch.element_data_{1} = BoundaryElement(patch.dim_, [5 6 7 8], neighbor_element_id, neighbor_element_data);
    patch.element_data_{1}.generateOrientation();
    ...
    %>> define element
    patch.element_data_{1} = BoundaryElement(patch.dim_, [1 2 6 5], neighbor_element_id, neighbor_element_data);
    patch.element_data_{1}.generateOrientation();
    ...
    %>> define element
    patch.element_data_{1} = BoundaryElement(patch.dim_, [2 3 7 6], neighbor_element_id, neighbor_element_data);
    patch.element_data_{1}.generateOrientation();
    ...
    %>> define element
    patch.element_data_{1} = BoundaryElement(patch.dim_, [3 4 8 7], neighbor_element_id, neighbor_element_data);
    patch.element_data_{1}.generateOrientation();
    ...
    %>> define element
    patch.element_data_{1} = BoundaryElement(patch.dim_, [1 4 8 5], neighbor_element_id, neighbor_element_data);
    patch.element_data_{1}.generateOrientation();
end
